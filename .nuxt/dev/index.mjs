import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, getRequestHost, getRequestProtocol, getQuery, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, setHeader, getHeader, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText, H3Error } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import fs, { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import defu$1, { defu, createDefu, defuFn } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/defu/dist/defu.mjs';
import { html as html$1 } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/satori-html/dist/index.js';
import { withQuery, joinURL, withTrailingSlash, hasProtocol, withHttps, withoutProtocol, parseURL, withoutTrailingSlash, withLeadingSlash, withBase, withoutBase, getQuery as getQuery$1, joinRelativeURL, withoutLeadingSlash, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/ufo/dist/index.mjs';
...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { defineHeadPlugin } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/@unhead/shared/dist/index.mjs';
import { createHooks } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/hookable/dist/index.mjs';
...
import { createStorage, prefixStorage, normalizeKey } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/unstorage/dist/index.mjs';
...
import { getContext } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/errx/dist/index.js';
import devalue from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { resolve as resolve$1 } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/pathe/dist/index.mjs';
import Fuse from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/fuse.js/dist/fuse.mjs';
import { readFile } from 'node:fs/promises';
import { diffLines } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/diff/lib/index.mjs';
import MagicString from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/magic-string/dist/magic-string.es.mjs';
import { hash } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/ohash/dist/index.mjs';
import lruCacheDriver from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/unstorage/drivers/lru-cache.mjs';
import { Resvg } from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///home/roy/Projects/reproduction/reproduction/node_modules/satori/dist/index.js';
...
const _yyf1RihQOo = (function(nitro) {
...
const _inlineRuntimeConfig = {
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "name": "Welcome to Nuxt",
        "description": "My awesome Nuxt project",
        "defaultLocale": "en"
      }
    ],
    "version": "2.2.18",
  ...
  "nuxt-og-image": {
    ...
    "debug": true,
    "baseCacheKey": "/cache/nuxt-og-image/3.0.6",
    "fonts": [
      {
        "cacheKey": "Inter:400",
        "style": "normal",
...
const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/home/roy/Projects/reproduction/reproduction/.nuxt/cache/nuxt-og-image@3.0.6/_fonts"},{"baseName":"server","dir":"/home/roy/Projects/reproduction/reproduction/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/roy/Projects/reproduction/reproduction","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/roy/Projects/reproduction/reproduction/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/roy/Projects/reproduction/reproduction/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/roy/Projects/reproduction/reproduction/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/roy/Projects/reproduction/reproduction/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _9DmV8gDtWS = defineNitroPlugin(async (nitroApp) => {
...
const _AARVP3oQnp = defineNitroPlugin(async (nitroApp) => {
...
const _CYicIcvGei = defineNitroPlugin(async (nitro) => {
  return;
});
...
const _mZsHpQ = defineEventHandler(async (e) => {
...
const _Jd3REj = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _Gqx5GF = defineEventHandler(async (e) => {
...
const _mJKZ3W = defineEventHandler(async (e) => {
...
const _9etViB = defineEventHandler(async (e) => {
...
const _9SKkaQ = defineEventHandler(async (e) => {
...
const _2BoJWx = defineEventHandler(async (e) => {
...
const _cU1XGH = defineEventHandler(async (e) => {
...
const _nlZhyC = defineEventHandler(async (e) => {
...
const _izXuNv = defineEventHandler(async (e) => {
...
const _yQrtDy = defineEventHandler(async (e) => {
  const path = parseURL(e.path).pathname;
  if (fileMapping[path]) {
...
const _a6PR6p = defineEventHandler(async (e) => {
...
const _B42ADs = defineCachedEventHandler(async (e) => {
  const runtimeConfig = useRuntimeConfig().public["nuxt-link-checker"] || {};
  const linkDb = [
    ...pagePaths
  ];
...
const _4uiRhp = defineEventHandler(async (e) => {
  return {
    runtimeConfig: useRuntimeConfig(e).public["nuxt-link-checker"]
  };
});

const _lazy_OXue9B = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_WwlxDY = () => Promise.resolve().then(function () { return font$1; });
const _lazy_SkpV7T = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_OEovWC = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_OXue9B, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _mZsHpQ, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _Jd3REj, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _Gqx5GF, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _mJKZ3W, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug.json', handler: _9etViB, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _9SKkaQ, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _2BoJWx, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _cU1XGH, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _nlZhyC, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_WwlxDY, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_SkpV7T, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_OEovWC, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_OEovWC, lazy: true, middleware: false, method: undefined },
  { route: '/__schema-org__/debug.json', handler: _izXuNv, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _yQrtDy, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/inspect', handler: _a6PR6p, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/links', handler: _B42ADs, lazy: false, middleware: false, method: undefined },
  { route: '/__link-checker__/debug.json', handler: _4uiRhp, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_OXue9B, lazy: true, middleware: false, method: undefined }
];
...
async function useSharp() {
  sharpInstance.instance = sharpInstance.instance || await import('file:///home/roy/Projects/reproduction/reproduction/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
  return sharpInstance.instance;
}
async function useCssInline() {
  cssInlineInstance.instance = cssInlineInstance.instance || await import('file:///home/roy/Projects/reproduction/reproduction/node_modules/unenv/runtime/mock/empty.mjs').then((m) => m.default);
...
const getServerEntry = () => import('file:///home/roy/Projects/reproduction/reproduction/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
